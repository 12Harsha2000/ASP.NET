    ...
    public partial class SiteMaster : MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string visitorCount = "  | You are visitor number " + Application["Counter"].ToString();

                LabelHeaderText.Text = headerText + visitorCount;
                LabelFooterText.Text = footerText + visitorCount;// Set the footer text
            }
